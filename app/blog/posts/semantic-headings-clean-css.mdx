...
CSS-in-JS setup. (And at the end of the post I'll touch on how to do something
similar-ish with SCSS if you've yet to be convinced that _All of Ur Interwebs R 
Belong 2 JavaScript_.)
...
WORDSMITH Okay but what about text that isn't using elements, like something coming from
